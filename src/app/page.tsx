...
export default function HomePage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050505]">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-900/25 via-transparent to-transparent" />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-4xl flex-col px-6 py-16 sm:py-24">
        <header className="mb-16">
          ...
          <p className="mt-4 max-w-lg text-lg text-white/60">
            Choose what you&apos;d like to open — your season wrapped or the
            sweepstake.
          </p>
        </header>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <OptionCard
            ...
            description="Your season in motion — auto-suggested fun facts, hard stats, and a 60-second recap."
            accent="emerald"
            badge="Season review"
          />
          <OptionCard
